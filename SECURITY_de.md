...
**Unterstützte Linien:** 2.2.0 BETA (experimentell) · 1.3.1 (stabile Baseline)
...
Eingangsbestätigung, Schweregrad, Behebung, Release-Koordination und Offenlegungszeitpunkt werden fallbezogen behandelt. Die stabile Linie 1.3.1 und der Branch 2.2.0 BETA werden entsprechend ihrem jeweiligen Release-Status geprüft. Die BETA-Funktionen für Analyzer und Import erfordern besondere Aufmerksamkeit, weil lokale Dateien und Archive verarbeitet werden.
