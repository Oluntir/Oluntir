# DEV_011 – Galerie-Bereich als MAIN-Einschub

## Ziel

DEV_011 implementiert ausschließlich das produktionsreife Einschieben eines vollständig neuen Galerie-Bereichs zwischen direkten Layoutbereichen von `MAIN`.
