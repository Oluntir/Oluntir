> **Language:** English (reference) · [Deutsch](QUICK-SETUP_de.md)
...
Provides initial project configuration for framework profile and common page settings. It reduces setup steps but does not bypass mandatory project-type selection.
