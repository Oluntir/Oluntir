> **Language:** English (reference) · [Deutsch](QUICK-EDITING_de.md)
...
Provides direct editing actions for common page content. Operations must update the current project model and remain compatible with undo, save, preview, and export behavior.
