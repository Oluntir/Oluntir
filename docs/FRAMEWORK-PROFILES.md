...
Framework profiles define the bundled CSS and JavaScript resources used by a project. Oluntir 1.0.0 includes Bootstrap 4.6.2 and Bootstrap 5.3.8 profiles. Profiles must remain versioned and offline-capable.
