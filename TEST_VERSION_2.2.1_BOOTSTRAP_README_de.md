# Oluntir 2.2.1 – Bootstrap-Teststand
...
- Wiederholbare Bereiche werden in 2.2.1 **zentral** verwaltet; Seiteninstanzen sind materialisiert und dort gegen direkte Inhaltsbearbeitung gesperrt.
...
2. Im Startdialog muss ein älterer Metadatenstand als Übernahme auf **2.2.1** gekennzeichnet werden; nach dem ersten Öffnen/Speichern muss 2.2.1 persistiert sein.
...
3. Repeat-Bibliothek öffnen: Oben müssen **„Repeat-Bibliothek“** und der Untertitel **„Bereich zentral bearbeiten“** erscheinen. Die kompakte Scrollliste muss alle Familien mit Seitenverwendung/Vorkommen/Revision zeigen. Die Schalter **„Zuletzt angelegt“** und **„A–Z“** müssen die Reihenfolge umstellen; **„Gesamtliste erweitern“** muss den Scrollbereich vergrößern. Pro Eintrag darf oben nur **„Zentral bearbeiten“** angeboten werden.
...
## Repeat-Zielgrenzen auf Seitenebene

1. Eine Seite verwenden, bei der ein normaler Inhaltsbereich (z. B. Hero-`section`) als Geschwister von `<main>` direkt vor dem Footer liegt.
2. In der Repeat-Bibliothek eine Quelle zum Einsetzen auswählen.
3. Zielseite öffnen und den Mauszeiger in den freien Bereich zwischen Hero und Footer bewegen.
4. Erwartet: orange Einfügelinie am Hero; Klick bestätigt die Position. Der Footer selbst darf niemals als Repeat-Ziel freigegeben werden.

## Export-Symbole

- In der GrapesJS-Werkzeugleiste müssen die beiden Archivsymbole kleine, eindeutig lesbare **ZIP**- bzw. **TAR**-Badges tragen.
