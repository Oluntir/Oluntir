...
**Supported line:** 2.2.1 (current release) · 1.3.1 (stable baseline)
...
Receipt, severity, remediation, release coordination, and disclosure timing are handled case by case. The 1.3.1 stable line and the 2.2.1 branch are evaluated according to their respective release status. Analyzer and import paths require additional scrutiny because they process local files and archives.
