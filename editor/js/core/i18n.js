...
(function () {
  ...
  const messages = {
    de: {
      ...
      'toolbar.rename':'Umbenennen', 'toolbar.delete':'Löschen', 'toolbar.gallery':'+ Bildergalerie', 'toolbar.folderGallery':'+ Galerie aus Ordner', 'toolbar.uploadImage':'+ Bild hochladen',
      'toolbar.exportFolder':'Export in Ordner', 'toolbar.interface':'Oberfläche', 'toolbar.save':'Speichern',
      'toolbar.backupSave':'Backup speichern', 'tool.favicon':'Projekt-Favicon festlegen', 'tool.monitorToggle':'Werkzeugspalte auslagern oder zurückholen', 'tool.monitorFocus':'Werkzeugfenster in den Vordergrund holen', 'tool.repeatContent':'Wiederholbare Bereiche erstellen/bearbeiten', 'tool.repeatLibrary':'Wiederholbare Bereiche aus Liste einfügen', 'toolbar.frameworkTitle':'Framework-Profil auswählen',
      'tool.exportFolder':'Website in einen lokalen Ordner exportieren', 'tool.exportZip':'Website als ZIP exportieren', 'tool.exportTar':'Website als TAR exportieren',
      'toolbar.newPageTitle':'Neue Seite anlegen', 'toolbar.renameTitle':'Seite umbenennen',
      'toolbar.deleteTitle':'Seite löschen',
    ...
    en: {
      ...
      'toolbar.rename':'Rename', 'toolbar.delete':'Delete', 'toolbar.gallery':'+ Image gallery', 'toolbar.folderGallery':'+ Gallery from folder', 'toolbar.uploadImage':'+ Upload image',
      'toolbar.exportFolder':'Export to folder', 'toolbar.interface':'Interface', 'toolbar.save':'Save',
      'toolbar.backupSave':'Save backup', 'tool.favicon':'Set project favicon', 'tool.monitorToggle':'Move tool column out or back', 'tool.monitorFocus':'Bring tool window to front', 'tool.repeatContent':'Create/edit repeatable sections', 'tool.repeatLibrary':'Insert repeatable sections from list', 'toolbar.frameworkTitle':'Select framework profile',
      'tool.exportFolder':'Export website to a local folder', 'tool.exportZip':'Export website as ZIP', 'tool.exportTar':'Export website as TAR',
      'toolbar.newPageTitle':'Create a new page', 'toolbar.renameTitle':'Rename page',
      'toolbar.deleteTitle':'Delete page',
