...
(function () {
  ...
  const messages = {
    de: {
      ...
      'toolbar.backupSave':'Backup speichern', 'tool.monitorToggle':'Werkzeugspalte auslagern oder zurückholen', 'tool.monitorFocus':'Werkzeugfenster in den Vordergrund holen', 'toolbar.frameworkTitle':'Bootstrap-Profil auswählen',
    ...
    en: {
      ...
      'toolbar.backupSave':'Save backup', 'tool.monitorToggle':'Move tool column out or back', 'tool.monitorFocus':'Bring tool window to front', 'toolbar.frameworkTitle':'Select Bootstrap profile',
