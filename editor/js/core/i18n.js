...
(function () {
  ...
  const messages = {
    de: {
      ...
      'toolbar.backupSave':'Backup speichern', 'tool.favicon':'Projekt-Favicon festlegen', 'tool.monitorToggle':'Werkzeugspalte auslagern oder zurückholen', 'tool.monitorFocus':'Werkzeugfenster in den Vordergrund holen', 'toolbar.frameworkTitle':'Framework-Profil auswählen',
    ...
    en: {
      ...
      'toolbar.backupSave':'Save backup', 'tool.favicon':'Set project favicon', 'tool.monitorToggle':'Move tool column out or back', 'tool.monitorFocus':'Bring tool window to front', 'toolbar.frameworkTitle':'Select framework profile',
